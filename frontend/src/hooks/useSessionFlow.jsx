...
export default function useSessionFlow(initialStep = 1) {
	...
	const setNoteBefore = (value) =>
		dispatch({ type: "SET_NOTE_BEFORE", payload: value });
	const setNoteAfter = (value) =>
		dispatch({ type: "SET_NOTE_AFTER", payload: value });
	const togglePreference = (pref) =>
		dispatch({ type: "TOGGLE_PREFERENCE", payload: pref });
